    ...
    <div class="card collapse-sidebar c-scrollbar-light shadow-none">
        <div class="card-header pr-1 pl-3">
            ...
            <button class="btn btn-sm p-2 d-xl-none filter-sidebar-thumb" data-toggle="class-toggle"
                ...
                <i class="fa-solid fa-times la-2x"></i>
            </button>
        </div>
        <div class="card-body">
            <div class="pb-4">
                <form action="{{ route('member.listing') }}" method="get">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="member_code" value="{{ $member_code }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                                ...
                                <select class="form-control aiz-selectpicker" name="marital_status"
                                    ...
                                    @foreach ($marital_statuses as $marital_status)
                                        <option value="{{ $marital_status->id }}"
                                            @if ($matital_status == $marital_status->id) selected @endif>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="religion_id" id="religion_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                                    <option value="">{{ translate('Choose One') }}</option>
                                    @foreach ($religions as $religion)
                                        <option value="{{ $religion->id }}"
                                            @if ($religion->id == $religion_id) selected @endif> {{ $religion->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="caste_id" id="caste_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                                    <option value="">{{ translate('Select One') }}</option>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="sub_caste_id" id="sub_caste_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                                    <option value="">{{ translate('Select One') }}</option>
                                </select>
                            </div>
                                ...
                                <select name="mother_tongue" class="form-control aiz-selectpicker"
                                    ...
                                    @foreach ($mother_tongues as $mother_tongue_select)
                                        <option value="{{ $mother_tongue_select->id }}"
                                            @if ($mother_tongue_select->id == $mother_tongue) selected @endif>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="country_id" id="country_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                                    <option value="">{{ translate('Select One') }}</option>
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}"
                                            @if ($country->id == $country_id) selected @endif>{{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="state_id" id="state_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="city_id" id="city_id" class="form-control aiz-selectpicker"
                                    data-live-search="true">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="min_height" value="{{ $min_height }}"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="max_height" value="{{ $max_height }}"
                                    class="form-control" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="aiz-radio-list">
                        <label class="aiz-radio">
                            <input type="radio" name="member_type" value="2" onchange="applyFilter()"
                                @if ($member_type == 2) checked @endif> {{ translate('Premium Member') }}
                            <span class="aiz-rounded-check"></span>
                        </label>
                        <label class="aiz-radio">
                            <input type="radio" name="member_type" value="1" onchange="applyFilter()"
                                @if ($member_type == 1) checked @endif> {{ translate('Free member') }}
                            <span class="aiz-rounded-check"></span>
                        </label>
                        <label class="aiz-radio">
                            <input type="radio" name="member_type" value="0"
                                @if ($member_type == 0) checked @endif> {{ translate('All Member') }}
                            <span class="aiz-rounded-check"></span>
                        </label>
                    </div>
