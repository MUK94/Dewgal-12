                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-xl-none ml-auto mb-1 ml-xl-3 mr-0 align-self-end">
                                    <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle"
                                        ...
                                        <i class="fa-solid fa-list la-2x"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="mb-5">
                                                ...
                                                <div class="row gutters-5 text-center">
                                                    ...
                                                    @else
                                                        href="{{ route('member_profile', $user->id) }}" @endif
                                                            ...
                                                            <i class="fa-solid fa-user fs-20 text-primary"></i>
                                                            <span
                                                    ...
                                                    @elseif($interest_onclick == 'do_response')
                                                        href="{{ route('interest_requests') }}" @endif
                                                            class="text-reset c-pointer">
                                                            <i class="fa-solid fa-heart fs-20 text-primary"></i>
                                                    ...
                                                    @else
                                                        onclick="remove_shortlist({{ $user->id }})" @endif
                                                            class="text-reset c-pointer">
                                                            <i class="fa-solid fa-list fs-20 text-primary"></i>
                                                    ...
                                                    <div class="col">
                                                        <a onclick="ignore_member({{ $user->id }})"
                                                            ...
                                                            <span class="text-dark">
                                                                <i class="fa-solid fa-ban fs-20 text-primary"></i>
                                                                <span
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <a id="report_a_id_{{ $user->id }}"
                                                            ...
                                                            <span id="report_id_{{ $user->id }}"
                                                                class="{{ $report_class }}">
                                                                <i class="fa-solid fa-info-circle fs-20 text-primary"></i>
                                                                <span
