                ...
                <div class="col-xl-4 col-xxl-3 order-1 order-xl-0">
                    <div class="aiz-profile-sidebar">
                        <div class="overflow-hidden position-relative rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                            ...
                            >
                            @if(!$profile_picture_show)
                                <div class="absolute-full d-flex justify-content-center align-items-center bg-soft-dark text-white"><i class="fa-solid fa-lock la-3x"></i></div>
                            @endif
                            ...
                            @if (Auth::user()->id != $user->id)
                                <div class="mb-2 mt-4">
                                    ...
                                    <a href="avascript:void(0);" id="shortlist_a_id_{{ $user->id }}"
                                        ...
                                        <i class="fa-solid fa-list d-block la-2x"></i>
                                ...
                                <div class="row gutters-5">
                                    <div class="col">
                                        <a href="avascript:void(0);" onclick="ignore_member({{ $user->id }})"
                                            class="btn btn-block btn-primary text-left">
                                            <i class="fa-solid fa-ban d-block la-2x"></i>
                                            {{ translate('Ignore') }}
                                        </a>
                                    </div>
                                    <div class="col">
                                        ...
                                        <a href="avascript:void(0);" id="report_a_id_{{ $user->id }}" @if ($report_onclick == 1)
                                            ...
                                            @endif
                                            class="btn btn-block btn-primary text-left">
                                            <i class="fa-solid fa-info-circle d-block la-2x"></i>
                                                    ...
                                                    @if (Auth::user()->id != $user->id)
                                                        @if ($user->phone != null)
                                                            <div class="d-flex mb-3">
                                                                <i class="fa-solid fa-phone text-primary la-2x mr-3"></i>
                                                                <div>
                                                        ...
                                                        @if ($user->email != null)
                                                            <div class="d-flex">
                                                                <i class="fa-solid fa-envelope text-primary la-2x mr-3"></i>
                                                                <div>
                                                                    <div class="fs-15 fw-600 mb-1">
                                        ...
                                        @if ($gallery_image_show)
                                            ...
                                            <div class="overlay">
                                                <a target="_blank" href="{{ uploaded_asset($gallery_image->image) }}"
                                                    ...
                                                    title="View">
                                                    <i class="fa-solid fa-search-plus la-2x"></i>
                                                </a>
                                            </div>
                                        @else
