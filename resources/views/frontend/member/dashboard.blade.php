    ...
    <div class="row gutters-5 row-cols-xl-{{ $col }} row-cols-2">
        <div class="col mx-auto mb-3">
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="fa-solid fa-heart la-2x mb-3 text-primary-grad"></i>
                <div class="h4 fw-700 text-primary-grad">{{ get_remaining_package_value($user->id, 'remaining_interest') }}
                </div>
        ...
        <div class="col mx-auto mb-3">
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="fa-solid fa-phone la-2x mb-3 text-primary-grad"></i>
        ...
        <div class="col mx-auto mb-3">
            <div class="bg-light rounded overflow-hidden text-center p-3">
                <i class="fa-solid fa-image la-2x mb-3 text-primary-grad"></i>
        ...
        @if ($profile_picture_privacy == 'only_me')
            <div class="col mx-auto mb-3">
                <div class="bg-light rounded overflow-hidden text-center p-3">
                    <i class="fa-solid fa-user-circle la-2x mb-3 text-primary-grad"></i>
                    <div class="h4 fw-700 text-primary-grad">
        ...
        @if ($gallery_image_privacy == 'only_me')
            <div class="col mx-auto mb-3">
                <div class="bg-light rounded overflow-hidden text-center p-3">
                    <i class="fa-solid fa-images la-2x mb-3 text-primary-grad"></i>
                    <div class="h4 fw-700 text-center text-primary-grad">
                    ...
                    <ul class="list-group list-group-raw fs-15 mb-4 pb-4 border-bottom">
                        ...
                        <li class="list-group-item py-2 text-line-through">
                            @if ($user->member->package->auto_profile_match == 0)
                                <i class="fa-solid fa-times text-danger mr-2"></i>
                        ...
                        <div>
                            ...
                            @empty
                                <div class="alert alert-info">
                                    {{ translate('Update your partner expectation for auto match making') }}</div>
                            @endforelse
                        </div>
                    @else
