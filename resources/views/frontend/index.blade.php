                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select @error('on_behalf') is-invalid @enderror"
                                    ...
                                    <div class="row gutters-5">
                                        ...
                                        <div class="col-lg">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="mother_tongue" class="form-control" data-live-search="true"
                                                    data-container="body">
                            ...
                            @foreach (json_decode(get_setting('homepage_reviews')) as $key => $review)
                                <div class="carousel-box">
                                    <div class="text-center px-lg-9">
                                        ...
                                        <i class="fa-solid fa-quote-right la-10x text-dark opacity-30"></i>
                                    </div>
                                </div>
                            @endforeach
                        </div>
