                                ...
                                @if (!empty(get_setting('linkedin_link')))
                                    <li class="list-inline-item">
                                        <a href="{{ get_setting('linkedin_link') }}" target="_blank"
                                            class="linkedin"><i class="fa-brands fa-linkedin-in"></i></a>
                                    </li>
                                @endif
                            </ul>
                        </div>
    ...
    <div class="row align-items-center gutters-5 text-center">
        <div class="col">
            <a href="{{ route('home') }}" class="text-reset d-block flex-grow-1 text-center py-2">
                <i class="las fa-home fs-18 opacity-60 {{ areActiveRoutes(['home'], 'opacity-100') }}"></i>
                <span
        ...
        <div class="col">
            <a href="{{ route('frontend.notifications') }}" class="text-reset d-block flex-grow-1 text-center py-2">
                <span class="d-inline-block position-relative px-2">
                    <i
                        class="las fa-bell fs-18 opacity-60 {{ areActiveRoutes(['frontend.notifications'], 'opacity-100') }}"></i>
        ...
        <div class="col">
            <a href="{{ route('all.messages') }}"
                ...
                <span class="d-inline-block position-relative px-2">
                    <i
                        class="las fa-comment-dots fs-18 opacity-60 {{ areActiveRoutes(['all.messages'], 'opacity-100') }}"></i>
                    @if (Auth::check() && Auth::user()->user_type == 'member')
                        @php
