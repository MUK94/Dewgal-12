            ...
            <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    ...
                    <div class="h3 fw-700 mb-3">
                        {{ \App\Models\User::where('user_type', 'member')->where('membership', 2)->count() }}</div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                        d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    ...
                    <div class="h3 fw-700 mb-3">
                        {{ \App\Models\User::where('user_type', 'member')->where('membership', 1)->count() }}</div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                        d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    ...
                    <div class="h3 fw-700 mb-3">
                        {{ \App\Models\User::where('user_type', 'member')->where('blocked', 1)->count() }}</div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                        d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
            ...
            <div class="h-100 row gutters-10">
                <div class="col-6 mb-3">
                    <div class="bg-white h-100 px-3 py-4 rounded shadow-sm d-flex flex-column justify-content-center">
                        ...
                        <div class="h2">
                            {{ single_price(\App\Models\PackagePayment::where('payment_status', 'Paid')->get()->sum('amount')) }}
                        </div>
                    </div>
                </div>
                <div class="col-6 mb-3">
    ...
    <div class="row gutters-10">
        <div class="col-xxl-8 col-xl-7">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="aiz-carousel gutters-10" data-items='4' data-xl-items='3' data-lg-items='4'
                        data-md-items='3' data-sm-items='2' data-xs-items='1'>
                        ...
                        @foreach ($happy_stories as $key => $happy_story)
                            ...
                            <div class="carousel-box">
                                <div class="card overflow-hidden mb-4">
                                    ...
                                    <div class="p-3">
                                        <div class="fw-600 text-truncate mb-2">
