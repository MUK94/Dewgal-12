            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="aiz-side-nav-link">
                        <i class="fa-solid fa-gauge-simple mr-1"></i>
                ...
                @can('show_packages')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('packages.index') }}"
                            ...
                            <i class="fa-solid fa-home aiz-side-nav-icon"></i>
                ...
                @can('show_package_payments')
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('package-payments.index') }}" class="aiz-side-nav-link">
                            <i class="fa-solid fa-money-bill-alt aiz-side-nav-icon"></i>
                ...
                @if (get_setting('wallet_system'))
                    @if (auth()->user()->can('wallet_transaction_history') || auth()->user()->can('offline_wallet_recharge_requests'))
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <i class="fa-solid fa-dollar-sign aiz-side-nav-icon"></i>
                ...
                @can('show_happy_stories')
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('happy-story.index') }}"
                            ...
                            <i class="fa-solid fa-handshake aiz-side-nav-icon"></i>
                ...
                @if (auth()->user()->can('show_blog_categories') || auth()->user()->can('show_blogs'))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="fa-solid fa-blog aiz-side-nav-icon"></i>
                ...
                @can('newsletter')
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="fa-solid fa-bullhorn aiz-side-nav-icon"></i>
                ...
                @can('show_contact_us_queries')
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('contact-us.index') }}"
                            ...
                            <i class="fa-solid fa-tty aiz-side-nav-icon"></i>
                ...
                @if (addon_activation('referral_system'))
                    @if (auth()->user()->can('set_referral_commission') ||
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <i class="fa-solid fa-money-bill aiz-side-nav-icon"></i>
                ...
                @if (addon_activation('support_tickets'))
                    @if (auth()->user()->can('show_active_tickets') ||
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <i class="fa-solid fa-people-carry aiz-side-nav-icon"></i>
                ...
                @if (addon_activation('otp_system'))
                    @if (auth()->user()->can('manage_sms_templates') ||
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <i class="fa-solid fa-phone aiz-side-nav-icon"></i>
                ...
                @can('show_uploaded_files')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('uploaded-files.index') }}"
                            ...
                            <i class="fa-solid fa-folder-open aiz-side-nav-icon"></i>
                ...
                @if (auth()->user()->can('header') ||
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="fa-solid fa-desktop aiz-side-nav-icon"></i>
                ...
                @if (auth()->user()->can('general_settings') ||
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="fa-solid fa-cog aiz-side-nav-icon"></i>
                ...
                @if (auth()->user()->can('show_staffs') || auth()->user()->can('show_staff_roles'))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="fa-solid fa-user-tie aiz-side-nav-icon"></i>
