                ...
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-danger btn-sm d-flex align-items-center"
                            ...
                            <i class="fa-solid fa-hdd fs-20"></i>
                    ...
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button"
                        ...
                        <span class="btn btn-icon p-1">
                            <span class=" position-relative d-inline-block">
                                <i class="fa-solid fa-bell la-2x"></i>
                                ...
                                @foreach ($notifications as $key => $notification)
                                    ...
                                    @if (!empty($user_data))
                                        <li
                                            ...
                                            <a href="{{ route('notification_view', $notification->id) }}"
                                                ...
                                                <div class="media-body">
                                                    <p class="mb-1">
                                                        {{ $user_data->first_name . ' ' . $user_data->last_name }}</p>
                        ...
                        <span class="d-flex align-items-center">
                            <span class="mr-md-2">
                                <img src="{{ uploaded_asset(Auth::user()->photo) }}"
                                    class="size-35px rounded-circle img-fit" height="36" width="36"
                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';">
                            </span>
                            <span class="d-none d-md-block">
                                <span
                                    class="d-block fw-500">{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</span>
