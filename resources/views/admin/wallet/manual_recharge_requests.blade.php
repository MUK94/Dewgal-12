                        ...
                        <tr>
                            ...
                            <td>
                                @if ($wallet->approval == 1)
                                    <span
                                        class="badge badge-inline badge-success text-center">{{ translate('Approved') }}</span>
                                @else
                                    <span
                                        class="badge badge-inline badge-info text-center">{{ translate('Pending') }}</span>
                                @endif
                            </td>
                            <td>{{ $wallet->created_at }}</td>
                            <td class="text-right">
                                <a href="javascript:void(0);"
                                    onclick="wallet_payment_details('{{ route('wallet_payment_details', $wallet->id) }}')"
