                ...
                <div class="card-body">
                    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('First Name') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Last Name') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Gender') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Date Of Birth') }}<span
                        ...
                        @endif
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('On Behalf') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                                @php $on_behalves = \App\Models\OnBehalf::all(); @endphp
                                <select class="form-select" name="on_behalf" required>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Package') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label" for="signinSrEmail">{{ translate('photo') }}
                                <small>(800x800)</small></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Password') }}<span class="text-danger">
                                    *</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">{{ translate('Confirm Password') }} <span
                                    class="text-danger"> *</span></label>
                            <div class="col-md-9">
                                ...
                                <small id="confirm_password_help" class="form-text text-muted"
                                    style="color: red; display: none;">{{ translate('Mismatch Password.') }}</small>
                        ...
                        <div class="form-group row text-right">
                            <div class="col-md-11">
                                <button type="submit" class="btn btn-primary" id="passSaveBtn"
                                    disabled>{{ translate('Add Member') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
