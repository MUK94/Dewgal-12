                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                @can('edit_happy_story')
                                    <a href="{{ route('happy-story.edit', encrypt($happy_story->id)) }}"
                                ...
                                @can('view_details_happy_story')
                                    <a href="{{ route('happy-story.show', encrypt($happy_story->id)) }}"
            ...
            $.post('{{ route('happy_story_approval.status') }}', {
                ...
                if (data == 1) {
                    AIZ.plugins.notify('success',
                        '{{ translate('Happy story appeoval status updated successfully') }}');
                } else {
