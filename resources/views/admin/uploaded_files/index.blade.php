...
<div id="info-modal" class="modal fade">
	<div class="modal-dialog modal-dialog-right">
            ...
            <i class="fa-solid fa-spinner la-spin la-3x opacity-70"></i>
        </div>
			</div>
		</div>
	</div>
...
@section('script')
	<script type="text/javascript">
      ...
      $('#info-modal-content').html('<div class="c-preloader text-center absolute-center"><i class="fa-solid fa-spinner la-spin la-3x opacity-70"></i></div>');
			var id = $(e).data('id')
